            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  Understanding Physiotherapy: What It Is and How It Helps
                </h1>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Physiotherapy is a trusted and effective method for treating
                    and preventing injuries, managing pain, and improving
                    overall physical health. Whether recovering from surgery or
                    managing a chronic condition, physiotherapy can help you
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Physiotherapy involves physical treatments such as exercise,
                    manual therapy, and electrotherapy, designed to relieve
                    pain, restore function, and improve movement. It’s used to
                    treat conditions affecting the muscles, joints, nerves, and
                    bones.
                  </p>
                  <h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Physiotherapists assess your condition, develop a
                    personalized treatment plan, and guide you through
                    therapeutic exercises or techniques. This may include
                    hands-on treatment like massage or joint manipulation to
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Reduces pain and inflammation Improves mobility and
                    flexibility Prevents further injury Enhances strength and
                    stability
                  </p>
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Physiotherapy is an essential tool for recovery, injury
                    prevention, and maintaining optimal physical health. If
                    you’re struggling with pain or limited movement, consider
                    consulting a physiotherapist to explore how treatment can
                    help you.
                  </p>
