...
const FAQ = () => {
  const title =
    "text-lg font-bold text-black dark:text-white sm:text-lg lg:text-lg xl:text-lg text-center";
  const description =
    "text-sm font-medium leading-relaxed text-body-color sm:text-sm sm:leading-relaxed text-center";
